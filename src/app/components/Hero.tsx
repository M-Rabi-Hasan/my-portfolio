...
import profilePic from "../assets/images/rabi-hassan.png";
      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-start">
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="my-2 max-w-xl motion.py-6 font-sans"
            >
              {HERO_CONTENT}
            </motion.p>
          </div>
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            ...
            >
              <Image src={profilePic} alt="Kevin Rush" width={300} height={400} />
            </motion.div>
          </div>
        </div>
      </div>
